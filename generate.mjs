...
// GitHub's API returns light-theme calendar colors (empty ≈ white #ebedf0).
// Remap them to the dark-theme palette so empty days read as dark, not white.
const DARK_MAP = {
  "#ebedf0": "#161b22", // level 0 (empty)
...
function toDark(color) {
  ...
  return DARK_MAP[color.toLowerCase()] || color;
}
